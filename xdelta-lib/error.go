...
const (
	XdeltaError_OK                  = XdeltaError(0)
	XdeltaError_ArgumentNull        = XdeltaError(101)
	XdeltaError_ArgumentOutOfRange  = XdeltaError(102)
	XdeltaError_Input               = XdeltaError(XdeltaState_INPUT)
	XdeltaError_Output              = XdeltaError(XdeltaState_OUTPUT)
	XdeltaError_GetSourceBlock      = XdeltaError(XdeltaState_GETSRCBLK)
	XdeltaError_GotHeader           = XdeltaError(XdeltaState_GOTHEADER)
	XdeltaError_WindowStart         = XdeltaError(XdeltaState_WINSTART)
	XdeltaError_WindowFinish        = XdeltaError(XdeltaState_WINFINISH)
	XdeltaError_TooFarBack          = XdeltaError(XdeltaState_TOOFARBACK)
	XdeltaError_Internal            = XdeltaError(XdeltaState_INTERNAL)
	XdeltaError_InvalidConfig       = XdeltaError(XdeltaState_INVALID)
	XdeltaError_InvalidInput        = XdeltaError(XdeltaState_INVALID_INPUT)
	XdeltaError_NoSecondCompression = XdeltaError(XdeltaState_NOSECOND)
	XdeltaError_NotImplemented      = XdeltaError(XdeltaState_UNIMPLEMENTED)
)
